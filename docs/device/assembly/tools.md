...
- Fume extractor/P100 mask or open windows + fan + N95/KF94/FFP2 mask
- Soldering iron stand
- Fire-resistant mat or surface (e.g. glass) to work on
- Helping hands (optional)
- Vise (optional, for holding the board while making holes)

## Testing

- USB-C cable (flashing and power)
- Multimeter
